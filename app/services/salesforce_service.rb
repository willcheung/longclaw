class SalesforceService
  ...
  def self.update_sfdc_contact(client: , sfdc_contact_id: , sfdc_account_id: , params: )
    ...
    begin
      ...
      detail = ""
      if (e.to_s[0...9]) == "NOT_FOUND" || (e.to_s[0...17]) == "ENTITY_IS_DELETED" || (e.to_s[0...27]) == "INVALID_CROSS_REFERENCE_KEY" # If SFDC Contact was deleted on Salesforce or otherwise cannot be found (invalid Id saved) or external SFDC Id of Contact is invalid
