...
class EntityFieldsMetadatum < ActiveRecord::Base
  ...
  def self.create_default_for(organization)
    ...
    #organization.entity_fields_metadatum.find_by(entity_type: ENTITY_TYPE[:Contact], name: "name").update(salesforce_field: "Name") if sfdc_contact_fields.include? "Name"
