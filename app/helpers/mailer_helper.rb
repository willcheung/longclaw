module MailerHelper
  ...
  def user_agent_helper(ua, domain)
    ...
    if user_agent.device.to_s == 'Other'
      ...
      if domain == ""
        "<img src=\"https://app.contextsmith.com/assets/fa-desktop.png\" width=\"15\" height=\"15\" border=\"0\" />&nbsp; Mac".html_safe
      else
        "<img src=\"https://app.contextsmith.com/assets/fa-desktop.png\" width=\"15\" height=\"15\" border=\"0\" />&nbsp; Mac on #{domain} network".html_safe
      end
      ...
      if domain == ""
        ("<img src=\"https://app.contextsmith.com/assets/fa-mobile.png\" width=\"15\" height=\"15\" border=\"0\" />&nbsp;" + user_agent.device.to_s).html_safe
      else
        ("<img src=\"https://app.contextsmith.com/assets/fa-mobile.png\" width=\"15\" height=\"15\" border=\"0\" />&nbsp;" + user_agent.device.to_s + " on #{domain} network").html_safe
      end
    end
  end
end