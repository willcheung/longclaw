class HomeController < ApplicationController
  ...
  def index
    ...
    unless @current_user_projects.blank?
      project_engagement_7d = Project.count_activities_by_category(@current_user_projects.ids, current_user.organization.domain, [current_user.email], 7.days.ago.midnight.utc, Time.current.end_of_day.utc).group_by { |p| p.id }
