class ReportsController < ApplicationController
  ...
  def get_remaining_top_dashboard_data
    ...
    stage_chart_result = @top_dashboard_data.map{|o| !o.is_closed ? [(o.stage_name.blank? ? '-Undefined-' : o.stage_name), o.amount] : [(o.is_won ? 'Closed Won' : 'Closed Lost'), o.amount]}.group_by{|n,a| n}.sort_by{|n,a| (['Closed Lost','Closed Won'].include? n) ? n : "           "+n }
